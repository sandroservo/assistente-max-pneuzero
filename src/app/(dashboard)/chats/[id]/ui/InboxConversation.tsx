                  ...
                  <div className="flex flex-col">
                    ...
                    <div
                      className={cn(
                        ...
                        isOut
                          ? isHuman
                            ? "bg-gradient-to-br from-gray-700 to-gray-800 text-white rounded-2xl rounded-tr-md"
                            : "bg-gradient-to-br from-red-600 to-red-700 text-white rounded-2xl rounded-tr-md"
                          ...
                          <div key={idx} className={cn(
                            ...
                            <div className="flex items-center gap-2 mb-2">
                              <div className={cn(
                                ...
                                isOut ? "bg-white/20 text-white" : "bg-red-100 text-red-600"
                              )}>
