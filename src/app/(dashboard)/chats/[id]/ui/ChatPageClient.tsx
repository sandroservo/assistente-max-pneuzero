        ...
        <header className="bg-white border-b px-3 md:px-6 py-3 flex items-center justify-between flex-shrink-0 gap-2">
          <div className="flex items-center gap-2 md:gap-4 min-w-0">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-full bg-red-50 hover:bg-red-100 text-[#CC0000] shrink-0 transition-colors"
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 group">
                    ...
                    {editingField === "name" ? (
                      <div className="flex items-center gap-2 mt-1">
                        <input
                          ...
                          className="flex-1 px-2 py-1 text-sm border rounded-md focus:ring-2 focus:ring-red-600 focus:outline-none"
                          autoFocus
                  ...
                  {editingField !== "name" && (
                    <button onClick={() => startEditing("name", lead.name)} className="opacity-0 group-hover:opacity-100 transition-opacity" aria-label="Editar nome">
                      <Pencil className="h-3.5 w-3.5 text-gray-400 hover:text-red-600" />
                    </button>
                  )}
                </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 text-sm border rounded-lg bg-white focus:ring-2 focus:ring-red-600 focus:outline-none cursor-pointer"
                ...
                <div className="p-3 rounded-lg bg-gray-50">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-bold text-red-600">{lead.leadScore}</span>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div key={rem.id} className="p-3 rounded-lg bg-blue-50 border border-blue-200 space-y-2">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-2 py-1.5 text-sm border rounded-md focus:ring-2 focus:ring-red-600 focus:outline-none"
                            />
                          </div>
                          <div>
                          ...
                          <div className="flex gap-2 pt-1">
                            <button
                              ...
                              className="flex-1 px-3 py-1.5 text-xs font-medium bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 transition-colors"
                            >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                          ...
                          >
                            <Pencil className="h-3.5 w-3.5 text-gray-500 hover:text-red-600" />
                          </button>
                          <button
          ...
          <div className="flex-1 p-6 overflow-auto space-y-4">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <textarea
                ...
                className="w-full h-32 p-3 border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-red-600 text-sm"
                defaultValue=""
