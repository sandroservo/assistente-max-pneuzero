...
function AsaasWebhookUrlCopy() {
  ...
  const url = typeof window !== "undefined"
    ...
    : `https://pneuzero.cloudservo.com.br${WEBHOOK_PATH}`;
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="https://pneuzero.cloudservo.com.br"
                />
                <p className="text-xs text-gray-500">
                  Deve ser a URL pública do painel (ex.: https://pneuzero.cloudservo.com.br). Usada ao registrar o webhook na Evolution e em outros integradores.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="https://n8n.pneuzero.com.br/webhook/transcribe"
                />
                <p className="text-xs text-gray-500">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="https://pneuzero.cloudservo.com.br/api/asaas/webhook"
                />
                <p className="text-xs text-gray-500">
