...
Seja muito bem-vindo(a) à Pneu Zero! �

Seu pedido foi confirmado. Em breve você receberá todas as instruções.

Qualquer dúvida, estou por aqui! 😊`,

  PAYMENT_OVERDUE: `⚠️ Olá! Notei que o pagamento do seu serviço na Pneu Zero está pendente.
