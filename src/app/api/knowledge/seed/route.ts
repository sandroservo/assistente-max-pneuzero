...
O associado deve permanecer por pelo menos 12 meses no clube.`,
  ...
  },
  {
    ...
    content: `A Pneu Zero é focada em pneus e serviços automotivos.
...
Os check-ups incluem exames de sangue, imagem e outros conforme o plano.`,
  ...
  {
    category: "faq",
    title: "O que é a Pneu Zero?",
    content: `A Pneu Zero é uma loja especializada em pneus e serviços automotivos. Aqui o cliente resolve tudo em um só lugar: pneus, alinhamento, suspensão, freios, óleo, elétrica e baterias.

Foco em atendimento consultivo e qualidade.`,
    keywords: "o que é, pneu zero, pneuzero, loja, serviços",
    priority: 7,
  },
];
