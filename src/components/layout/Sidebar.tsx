  ...
  const sidebarContent = (isMobile: boolean) => (
    <>
      <div className={cn("border-b border-gray-100 flex shrink-0", collapsed && !isMobile ? "p-2 justify-center" : "p-5 justify-center")}>
        <Link href="/" className={cn("flex justify-center rounded-xl bg-gray-900", collapsed && !isMobile ? "w-12 h-12 p-1.5" : "w-full p-3")}>
          <Image
            src="/assets/logo-transp.png"
            alt="Pneuzero"
            width={collapsed && !isMobile ? 40 : 200}
            height={collapsed && !isMobile ? 40 : 80}
