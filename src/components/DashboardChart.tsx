    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-4 flex-wrap">
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-gradient-to-r from-red-600 to-red-500" />
          <span className="text-xs text-gray-600">
            <span className="font-semibold text-gray-800">{totalLeads30d}</span> novos leads (30d)
          </span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-gradient-to-r from-gray-700 to-gray-500" />
          <span className="text-xs text-gray-600">
          ...
          <AreaChart data={dailyData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
            <defs>
              ...
              <linearGradient id="gradMsgs" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#333333" stopOpacity={0.2} />
